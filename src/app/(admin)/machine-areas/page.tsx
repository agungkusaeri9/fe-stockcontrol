...
export default function UserListPage() {
    const {
        ...
        keyword,
        pagination
    } = useFetchData(MachineAreaService.get, "machine-areas");
    const { mutate: remove } = useDeleteData(MachineAreaService.remove, "machine-areas");
    ...
    return (
        <div>
            <Breadcrumb items={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Machine Areas', href: '/machine-areas' }]} />
            <div className="space-y-6">
                <ComponentCard title="Machine Area List">
                    <ButtonLink size='xs' href="/machine-areas/create">Create Machine Area</ButtonLink>
                                        ...
                                        {machineAreas?.map((machineArea: any, index: number) => (
                                            <TableRow key={machineArea.id}>
                                                ...
                                                <TableCell className="px-5 py-3 text-gray-500 text-theme-sm dark:text-gray-400 flex gap-1">
                                                    <ButtonLink href={`/machine-areas/${machineArea.id}/edit`} variant='info' size='xs' className="text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                                                        Edit
                                                    </ButtonLink>
