                                        ...
                                        {suppliers?.map((supplier: any, index: number) => (
                                            <TableRow key={supplier.id}>
                                                ...
                                                <TableCell className="px-5 py-3 text-gray-500 text-theme-sm dark:text-gray-400 flex gap-1">
                                                    <ButtonLink href={`/suppliers/${supplier.id}/edit`} variant='info' size='xs' className="text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                                                        Edit
                                                    </ButtonLink>
                                                    <Button onClick={() => handleDelete(supplier.id)} variant='danger' size='xs' className="text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                                                        Delete
                                                    </Button>
                                                </TableCell>
                                            </TableRow>
