...
const SparepartTable = () => {
    ...
    const { data: spareparts } = useQuery({
        queryKey: ["spareparts"],
        queryFn: async () => {
            const response = await SparePartService.getAllSparePart();
    ...
    return (
        <>
            <ButtonLink size='xs' href="/spareparts">Add SparePart</ButtonLink>
                                ...
                                {spareparts?.map((sparepart: any, index: number) => (
                                    <TableRow key={sparepart.id}>
                                        ...
                                        <TableCell className="px-5 py-3 text-gray-500 text-theme-sm dark:text-gray-400 flex gap-1">
                                            <ButtonLink href='/sparepart/edit' variant='info' size='xs' className="text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                                                Edit
                                            </ButtonLink>
